...
const vars: Partial<GlobalTheme['common']> = {
  ...
  primaryColor: '#005497',
  primaryColorHover: '#BEE2FF',
  primaryColorPressed: '#005497',
...
const vars2 = {
  ...
  borderPrimary: '1px solid #0E62A9',
...
const themeOverrides: GlobalThemeOverrides = {
  ...
  Message: {
    ...
    colorWarning: '#593c27',
    closeMargin: '0',
    closeColorPressedError: '#fff',
    closeColorHoverError: vars.infoColor,
    closeColorPressedSuccess: '#fff',
    closeColorHoverSuccess: vars.infoColor,
    closeColorPressedWarning: '#fff',
